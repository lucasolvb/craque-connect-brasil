...
const Auth = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    confirmPassword: '',
    name: '',
    userType: 'jogador' as 'jogador' | 'clube' | 'empresario'
  });
    ...
    try {
      if (isLogin) {
        ...
        toast({
          ...
          description: "Bem-vindo de volta à FutTalent.",
        });
        navigate('/dashboard');
      } else {
        ...
        toast({
          ...
          description: "Bem-vindo à FutTalent. Vamos configurar seu perfil.",
        });
        navigate('/onboarding');
      }
    } catch (error) {
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center pb-6">
          ...
          <CardTitle className="text-2xl font-bold">
            {isLogin ? 'Entrar na FutTalent' : 'Criar Conta'}
          </CardTitle>
          <p className="text-gray-600">
            {isLogin 
              ? 'Entre na sua conta para continuar' 
              : 'Junte-se à maior rede de futebol do Brasil'
            }
          </p>
        </CardHeader>
            ...
            {!isLogin && (
              <>
                ...
                <div className="space-y-3">
                  ...
                  >
                    {userTypes.map((type) => (
                      <div key={type.value} className="flex items-center space-x-3 p-3 border rounded-lg hover:bg-gray-50 transition-colors">
